...
public class MainScreenDesktop {
	...
	public void readUserInput(String option) {		
		...
		case 7:
			...
			address = JOptionPane.showInputDialog("Endereço do estabelecimento: ");
		...
		case 10:
			...
			destination = JOptionPane.showInputDialog("Destinatário: ");
			content = JOptionPane.showInputDialog("Conteúdo da mensagem: ");
